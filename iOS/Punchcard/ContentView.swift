...
struct ContentView: View {
    ...
    @State private var editingItem: CustomerItem?
...
struct AddEditView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("Customer") {
                    TextField("Customer", text: $title)
                        .accessibilityIdentifier("titleField")
                }
                Section("Punches") {
                    TextField("Punches", text: $amountText)
                        .keyboardType(.decimalPad)
                        .accessibilityIdentifier("amountField")
                }
                Section("Last visit") {
                    DatePicker("Last visit", selection: $date, displayedComponents: .date)
                }
                Section("Reward earned") {
                    Toggle("Reward earned", isOn: $isComplete)
            ...
            .navigationTitle(mode == .add ? "Add Customer" : "Edit Customer")
            .toolbar {
